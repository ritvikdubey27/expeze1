...
//                            break;
    ...
    private void getEntries() {
        ...
        lineEntries.add(new Entry(10f, (float) octtotalb));
        lineEntries.add(new Entry(11f, (float) novtotalb));
        lineEntries.add(new Entry(12f, (float) dectotalb));
    }
